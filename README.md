...
|---|---|---|---|
| 💼 **[Suched Billing System (SBS V2)](https://www.suchedbillingsystem.com/)** | Modular SaaS billing platform with 3FA auth & Schema Synchronizer CLI | `PHP MVC` `TypeScript` `MySQL` | `PRODUCTION` |
| ⚡ **[Custom GitHub Stats Cards](https://github.com/pvraj1011/github-stats-cards)** | Zero-runtime-API static SVG stats cards & Snake animation pipeline | `TypeScript` `GraphQL` `Actions` | `STABLE` |
| 🧠 **[RAG & AI Agent Workflows](https://github.com/pvraj1011)** | Autonomous LLM query pipeline with vector store search & function calling | `Python` `LangChain` `OpenAI` | `ACTIVE` |
